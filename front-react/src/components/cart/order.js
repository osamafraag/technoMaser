...
export default function Order() {
    ...
    <div className="shadow border rounded fs-4" style={{width:"449px", height:"576px",color:"var(--text-color)"}}>
        ...
        <div className='m-4 d-flex'>
            ...
            <span className='' style={{marginLeft:"30%"}}>548 <FontAwesomeIcon icon={faDollarSign} /></span>
        </div>
        <div className='m-4 d-flex'>
            <div className='w-50'>Tax</div>
            <span className='' style={{marginLeft:"30%"}}>56 <FontAwesomeIcon icon={faDollarSign} /></span>
        </div>
        <div className='m-4 d-flex'>
            <div className='w-50' >Delivery</div>
            <span className='' style={{marginLeft:"30%"}}>45 <FontAwesomeIcon icon={faDollarSign} /></span>
        </div>
        <div className='border shadow my-2 mx-5'></div>
        <div className='m-4 d-flex'>
            <div className='w-50'>Total</div>
            <span className=''  style={{marginLeft:"30%"}} >154 <FontAwesomeIcon icon={faDollarSign} /></span>
        </div>
        <a className='btn text-light text-center fs-4 my-5' 
